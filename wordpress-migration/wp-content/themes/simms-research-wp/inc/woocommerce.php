...
// The shop archive renders a custom <collection-filter> (search + sort + count),
// so drop WooCommerce's default result-count and ordering dropdown that would
// otherwise duplicate them above the product grid.
add_action(
	'init',
	function (): void {
